...
func Command(name string, args ...string) *CommandS {
	return &CommandS{
		Name: name,
		Args: args,
	}
...
func (c *CommandS) Run(opts *RunOptions) error {
	if opts == nil {
		opts = &RunOptions{}
	}
...
func (c *CommandS) RunStdBytes(opts *RunOptions) (stdout, stderr []byte, err error) {
	if opts == nil {
		opts = &RunOptions{}
	}
...
func (c *CommandS) RunStdString(opts *RunOptions) (stdout, stderr string, err error) {
	stdoutBytes, stderrBytes, err := c.RunStdBytes(opts)
	return bytesToString(stdoutBytes), bytesToString(stderrBytes), err
}

func (c *CommandS) ExitCode() int {
